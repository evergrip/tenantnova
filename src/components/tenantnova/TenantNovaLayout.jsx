...
export default function TenantNovaLayout() {
  ...
  const adminLinks = [
    ...
    ["/admin/lease-participants", "Lease Participants"], ["/admin/ledger", "Portfolio Ledger"], ["/admin/arrears", "Arrears"], ["/admin/maintenance", "Maintenance"], ["/admin/documents", "Document Center"], ["/admin/audit-logs", "Audit Logs"], ["/admin/settings", "Organization Settings"]
  ];
  const tenantLinks = [["/tenant", "Dashboard"], ["/tenant/lease", "My Lease"], ["/tenant/ledger", "Rent Ledger & Payments"], ["/tenant/maintenance", "Maintenance"], ["/tenant/documents", "Documents"], ["/tenant/profile", "Profile"], ["/tenant/contact", "Contact Manager"]];
